...
class TablaMenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $menus = [
            ...
            //array('id' => '6', 'menu_id' => '0', 'nombre' => 'Gondola', 'url' => 'libro', 'orden' => '2', 'icono' => 'fas fa-truck', 'created_at' => $now, 'updated_at' => $now),
            array('id' => '6', 'menu_id' => '0', 'nombre' => 'Gondola', 'url' => 'gondola', 'orden' => '2', 'icono' => 'fas fa-truck', 'created_at' => $now, 'updated_at' => $now),
            //array('id' => '7', 'menu_id' => '0', 'nombre' => 'Fletes', 'url' => 'libro-prestamo', 'orden' => '3', 'icono' => 'fas fa-location-arrow', 'created_at' => $now, 'updated_at' => $now),
